...
const LoginLeftSide = () => {
  return (
    <div className="hedden md:flex w-1/2 bg-indigo-950 relative overflow-hidden border-r border-slate-200">
      <div className="absoulte -top-30 -left-30 w-72 h-72 bg-indigo-500/20 rounded-full blur-3xl"></div>
